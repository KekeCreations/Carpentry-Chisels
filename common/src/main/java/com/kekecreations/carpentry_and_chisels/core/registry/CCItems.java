...
public class CCItems {
    ...
    public static final Supplier<Item> CHISEL = registerItem("chisel", () -> new ChiselItem(2, new Item.Properties().attributes(ChiselItem.createAttributes(2)).stacksTo(1).durability(250)));
