...
public class CCModelTemplate {
    ...
    public static final ModelTemplate POLE;
    ...
    static {
        ...
        POLE = new ModelTemplate(Optional.of(ResourceLocation.tryBuild(Constants.MOD_ID, "pole").withPrefix("block/")), Optional.empty(), new TextureSlot[]{TextureSlot.TOP, TextureSlot.SIDE, TextureSlot.PARTICLE});
    }
}
