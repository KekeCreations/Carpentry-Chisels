...
public class CCFabricRegistries {
    ...
    public static void register() {
        ...
        FlammableBlockRegistry.getDefaultInstance().add(CCBlocks.CARVED_CRIMSON_WOOD.get(), 5, 20);
        ...
        FlammableBlockRegistry.getDefaultInstance().add(CCBlocks.CARVED_WARPED_WOOD.get(), 5, 20);
